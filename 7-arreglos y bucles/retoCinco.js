...
let arreglo = [8, 10, 25, 27, 2];
let media = 0;

for (let i = 0; i < arreglo.length; i++) {
   media+= arreglo[i] / arreglo.length;   
}

console.log(' a) El resultado del arreglo es ' + media);
...
for (let i = 0; i < arreglo.length; i++) {
    media2+= arreglo[i] / arreglo.length;    
 }

 console.log(' b) El resultado del arreglo es ' + media2);
