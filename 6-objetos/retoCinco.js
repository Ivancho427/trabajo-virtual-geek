const impr = document.querySelector('.imprimir').addEventListener('click', imprimir);

function imprimir (e) {

const val = document.querySelector('input').value;
const node = document.querySelector('input').nodeName;
const requi = document.querySelector('input').required;
